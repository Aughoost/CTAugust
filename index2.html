...
<head>
<meta charset="UTF-8">
<title>Chess Trainer Mode - Correct SAN Recommendations</title>
...
<script>
const engine = new Worker("js/stockfish-17.1-8e4d048.js");
...
function onDrop(source, target) {
    evalBeforeMove = prevScore;
    lastFENBeforeMove = game.fen();

    // Get best move for player BEFORE move
    getBestMoveForPlayer(lastFENBeforeMove);
    ...
    askEngine(game.fen(), 1); // Update evaluation after move
}
...
engine.onmessage = function(event) {
    ...
    // Handle best move for player BEFORE move
    ...
    // Handle evaluation after player move
